            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        JsonArray md_detail = res.get("md_detail_result").getAsJsonArray();
                        String pay_schedule = res.get("pay_schedule").getAsString();
                        String pu_start = res.get("pu_start").getAsString();
                        String pu_end = res.get("pu_end").getAsString();
